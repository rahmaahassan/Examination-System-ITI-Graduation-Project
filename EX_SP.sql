...
BEGIN TRY
    ...
    ELSE
        BEGIN
            ...
            -- Update Std_ID to the student's ID
            SELECT Q.* 
...
-- Test --
GenerateExam @Ex_No = 654321, @Crs_ID = 2, @Ex_Duration = 45, @Num_TF_Questions = 10, @Num_MCQ_Questions = 10

-- Exam Answers --
GO
CREATE PROCEDURE SaveExamAnswers
    @Ex_No INT,
    @Std_ID INT,
    @Qus_No INT,
    @Std_Ans INT
...
-- Test --
SaveExamAnswers @Ex_No = 123456, @Std_ID = 1, @Qus_No = 13, @Std_Ans = 1

-- Exam Correction --
GO
CREATE PROCEDURE GradeExam
    @Std_ID INT,
    @Ex_No INT
AS
BEGIN TRY
    ...
    ELSE
        BEGIN
            ...
            SELECT @GradePercentage = (@TotalCorrectAnswers * 100.0) / 10.0;
...
-- Test --
GradeExam @Ex_No = 654321, @Std_ID = 1
-- Exam Generation --
Go
ALTER PROCEDURE GenerateAnExam
    @Ex_NO INT,
	@Crs_ID INT,
    @Ex_Duration INT,
...
-- Test --
GO
SaveStudentExamAnswers @Ex_No = 123456, @Std_ID = 1, @Qus_No = 21, @Std_Ans = 2

-- Exam Correction & Student grade --
GO
ALTER PROCEDURE StudentModelAnswer
    @Std_ID INT,
    @Ex_No INT
AS
BEGIN TRY
    ...
    ELSE
        BEGIN
            ...
            SELECT @GradePercentage = (@TotalCorrectAnswers * 100.0) / COUNT(Qus_No)
			FROM Std_ExAnswer
			WHERE Ex_No = @Ex_No AND Std_Id = @Std_ID
...
-- Test --
GO
StudentModelAnswer @Ex_No = 654321, @Std_ID = 1